...
def parse_args():
    ...
    parser.add_argument('--global_min', type=float, default=0.0708354)
    parser.add_argument('--global_max', type=float, default=1.6697606)
    ...
    parser.add_argument('--eval_every_epoch', type=float, default=100)
    parser.add_argument('--plot_every_epoch', type=float, default=100)
