...
check_misregistration_hsi( ...
  'D:\jyu\selected_outdoor_64_aligned\low\test', ...
  'D:\jyu\selected_outdoor_64_aligned\high\test', ...
  'D:\jyu\selected_outdoor_64_aligned\misreg_report.csv', ...
  'D:\jyu\selected_outdoor_64_aligned\previews', ...
  struct( ...
...
for i=1:size(pairs,1)
    ...
    try
        ...
        if saveAligned
            ...
            [~,base,~] = fileparts(fLow);
            outMat = fullfile(opts.saveAlignedDir, [base '_aligned.mat']);
            data = alignedCube; %#ok<NASGU>
