...
check_misregistration_hsi( ...
  'D:\jyu\selected_indoor_64_registration\low', ...
  'D:\jyu\selected_indoor_64_registration\high', ...
  'D:\jyu\selected_indoor_64_registration\misreg_report.csv', ...
  'D:\jyu\selected_indoor_64_registration\previews', ...
  struct( ...
    'projMethod','median', ...   % 'band' | 'mean' | 'median' | 'pca'
    'bandForVis',30, ...        % used iff projMethod='band'
    'shiftThresh',1.0, ...
    'flowThresh',0.8, ...
    'saveAlignedDir','D:\jyu\selected_indoor_64_registration\lowAligned' ... % '' to skip saving aligned cubes
  ));
